...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newFootballModal">
...
<!-- Modal -->
<div class="modal fade" id="newFootballModal" tabindex="-1" aria-labelledby="newFootballModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="newFootballModalLabel">New Entry</h1>
