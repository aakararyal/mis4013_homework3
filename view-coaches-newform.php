    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method = "post" action = "">
                <div class="mb-3">
                  <label for="coName" class="form-label">Coach Name</label>
                  <input type="text" class="form-control" id="coName" name = "coName">
                </div>
                 <div class="mb-3">
                  <label for="coLocation" class="form-label">Office Location</label>
                  <input type="text" class="form-control" id="coLocation" name = "coLocation">
                </div>
