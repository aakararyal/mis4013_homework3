...
<body>
    ...
    <p style="color: #FFFFFF;">The following chart displays the number of players in the table by division and will update as players are added, edited, or deleted.</p>
</body>
</html>
